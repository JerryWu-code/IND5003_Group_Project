...
st.write("""
🚀 Welcome to the Green Taxi of New York City Dashboard! 🚀
...
📊 Ready to uncover the stories hidden in the data? Click away and let the data unfold the narrative of Green Taxi in 
NYC! 🌐✨
